 ...
 *
 * buildAgent 回調中 this 綁定為 ToolCallContext，可通過 this.agent 訪問父 Agent。
 */
export class AgentToolLazy implements Tool {
  ...
  /** 延遲構建 Agent 的回調。this = ToolCallContext */
  private buildAgent: (this: ToolCallContext, parsedArgs: any) => Agent | Promise<Agent>;

  constructor(options: {
    function: AgentNS.FunctionDefine;
    messages: AgentNS.Message[];
    buildAgent: (this: ToolCallContext, parsedArgs: any) => Agent | Promise<Agent>;
  }) {
