...
import { createLoadSkillTool, createCallSkillSubAgentTool } from "./skill-tools.js";
...
const disclosure = {
  description: "可用 Skill: git, docker",
  enum: ["git", "docker"],
};

describe("createLoadSkillTool", () => {
  it("工具名称和参数正确", () => {
    const tool = createLoadSkillTool(skillDirs, disclosure);
...
describe("createCallSkillSubAgentTool", () => {
  it("工具名称和参数正确", () => {
    const tool = createCallSkillSubAgentTool(skillDirs, disclosure);
