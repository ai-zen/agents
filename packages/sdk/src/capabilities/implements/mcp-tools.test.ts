...
import { createLoadMcpTool, createCallMcpTool, createReadMcpResourceTool } from "./mcp-tools.js";
...
const disclosure = {
  description: "可用 MCP 服务器: github, slack",
  enum: ["github", "slack"],
};
...
describe("createLoadMcpTool", () => {
  it("工具名称和参数正确", () => {
    ...
    const tool = createLoadMcpTool(manager, mcpConfigs, disclosure);
